...
interface SoldPropertiesPhotosProps {
...
export function SoldPropertiesPhotos({
  photos,
  onPhotosChange,
  onNext,
  onPrevious,
  onCancel,
}: SoldPropertiesPhotosProps) {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900">
          Photos de biens similaires vendus
        </h2>
        <p className="mt-1 text-sm text-gray-600">
          Ajoutez jusqu'à 4 photos de biens similaires récemment vendus dans le secteur pour une meilleure comparaison.
        </p>
      </div>
      ...
      {photos.length === 0 && tempPhotos.length === 0 && (
        <div className="mt-8 text-center py-12 border rounded-lg">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Commencez par ajouter des photos de biens similaires vendus
          </p>
        </div>
      )}
